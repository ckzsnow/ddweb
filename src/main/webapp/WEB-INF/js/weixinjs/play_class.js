...
function fillDataIntoHtml(data) {
	document.getElementById('teacher_image').setAttribute('src', data.teacher_image);
	...
	scriptNode.src = data.videosrc;
	document.getElementById('videodiv').appendChild(scriptNode);
}
