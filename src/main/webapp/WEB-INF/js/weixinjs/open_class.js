...
function createDataList(data) {
	...
	for (var i in data) {
		...
		liNode.innerHTML = "<img class='mui-media-object mui-pull-left' style='line-height: 120px;height:84px;width:115px;min-width: 115px;' src='"+data[i].image+"'><div class='mui-media-body'><p class='mui-ellipsis' tyle='font-size:15px;color:black;'>"+data[i].name+"</p><p class='mui-ellipsis-2'>"+data[i].course_abstract+"</p><p class='mui-ellipsis' style='color:#63d7a6;'><span class='mui-icon mui-icon-person-filled'></span>"+data[i].teacher+"</p></div>";
