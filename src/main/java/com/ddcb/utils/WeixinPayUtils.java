...
public class WeixinPayUtils {
	private static final Logger logger = LoggerFactory
			.getLogger(WeixinPayUtils.class);
	private static String appid = "wxbd6aef840715f99d";
	private static String appsecret = "fe6ad4e96e31bb5cc240904585629721";
	private static String partner = "1304885801";
	// 这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "zaq12wsxcde34rfvbgt56yhnmju78ki9";
	...
	public static String getPackage(WxPayDto tpWxPayDto) {
		...
		logger.debug("获取到的预支付ID：" + prepay_id);
